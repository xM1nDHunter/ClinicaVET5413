    ...
    public partial class PainelCliente : Form
    {
        ...
        private void bt_EditarAnimal_Click(object sender, EventArgs e)
        {
            if(dataGridCliente.SelectedRows.Count > 0 )
            {
                ...
                cb_EditAnimal.Text = dataGridCliente.CurrentRow.Cells[5].Value.ToString();
                dtp_EditNasci.Text  = dataGridCliente.CurrentRow.Cells[6].Value.ToString();
        ...
        {            
            var listaAnimal = dc.Animals.ToList();
            foreach(Animal animais in listaAnimal)
            {
                cb_AddAnimal.Items.Add(animais.Nome);
                cb_EditAnimal.Items.Add(animais.Nome);
            }
        ...
        private void txt_pesquisa_TextChanged(object sender, EventArgs e)
        {
            ...
            var cliente = from Cliente in dc.Clientes
                         where Cliente.Nome == clientePesquisa
                         select Cliente;
            ...
            {
                dataGridCliente.DataSource = dc.Medicos;
                dataGridCliente.Refresh();
            }
        }
        ...
        private bool Validacoes()
        {
            ...
            if (string.IsNullOrEmpty(cb_AddAnimal.Text))
            {
                MessageBox.Show("Insira o animal do respetivo Cliente!", "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
